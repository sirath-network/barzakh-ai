...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f3f4f6;">
    <table class="email-container" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f3f4f6;">
        <tr>
            <td align="center" style="padding: 40px 20px;">
                <table class="main-table" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; background: #ffffff; border-radius: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); overflow: hidden;">
                    <tr>
                        <td style="background: linear-gradient(135deg, #EA580C 0%, #F97316 100%); padding: 40px; text-align: center;">
                            <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: 700;">Your Verification Code</h1>
                            <p class="subtitle" style="color: rgba(255,255,255,0.9); margin: 10px 0 0; font-size: 16px;">Use this code to secure your account.</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 50px 40px;">
                            <div style="text-align: center;">
                                ...
                                <div class="otp-box" style="background-color: #F9FAFB; border: 2px dashed #EA580C; border-radius: 12px; padding: 25px; margin: 30px auto; display: inline-block;">
                                    <div class="otp-code" style="font-size: 36px; font-weight: 700; letter-spacing: 8px; color: #EA580C; font-family: 'Courier New', Courier, monospace;">
                                        ${otp}
                                    </div>
                                </div>
                                
                                <div class="info-box" style="background-color: #FEF3C7; border-left: 4px solid #F59E0B; border-radius: 8px; padding: 20px; margin: 30px 0; text-align: left;">
                                    <p class="info-text-title" style="margin: 0 0 5px; font-weight: 600; color: #92400E; font-size: 14px;">Security Notification</p>
                                    <p class="info-text-body" style="margin: 0; color: #A16207; font-size: 14px; line-height: 1.5;">This code will expire in <strong>10 minutes</strong>. Never share this code with anyone.</p>
                                </div>
                    ...
                    <tr>
                        <td class="footer" style="background-color: #F9FAFB; padding: 30px 40px; border-top: 1px solid #E5E7EB; text-align: center;">
                            ...
                            <p style="margin: 5px 0 0; color: #EA580C; font-weight: 600; font-size: 16px;">Sirath Support Team</p>
...
<head>
    ...
    <style>
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .subtitle, .footer-text, .alt-link-text {
                color: #9CA3AF !important;
            }
            .alt-link-box {
                background-color: #374151 !important;
        ...
        <tr>
            <td align="center" style="padding: 40px 20px;">
                <table class="main-table" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; background: #ffffff; border-radius: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); overflow: hidden;">
                    <tr>
                        <td style="background: linear-gradient(135deg, #EA580C 0%, #F97316 100%); padding: 40px; text-align: center;">
                            <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: 700;">Reset Password Request</h1>
                            <p class="subtitle" style="color: rgba(255,255,255,0.9); margin: 10px 0 0; font-size: 16px;">One more step to secure your account.</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 50px 40px;">
                            <div style="text-align: center;">
                                ...
                                <div class="reset-button" style="margin: 40px 0;">
                                    <a href="${resetUrl}" style="background: linear-gradient(135deg, #EA580C 0%, #F97316 100%); color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 12px; font-weight: 600; font-size: 16px; display: inline-block; box-shadow: 0 8px 15px rgba(234, 88, 12, 0.2);">
                                        Reset Password
                                    </a>
                                </div>
                                ...
                                <div class="info-box" style="background-color: #FEF3C7; border-left: 4px solid #F59E0B; border-radius: 8px; padding: 20px; margin: 30px 0; text-align: left;">
                                    <p class="info-text-title" style="margin: 0 0 5px; font-weight: 600; color: #92400E; font-size: 14px;">Security Notification</p>
                                    <p class="info-text-body" style="margin: 0; color: #A16207; font-size: 14px; line-height: 1.5;">This link will expire in <strong>1 hours</strong>. If you did not request a password reset, please ignore this email.</p>
                                </div>
                            </div>
                        </td>
                    </tr>
