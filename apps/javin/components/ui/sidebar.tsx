...
// Definisikan tipe untuk tampilan sidebar
type SidebarView = 'history' | 'settings';

// Tambahkan state baru ke dalam tipe Context
type SidebarContext = {
  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // Menyimpan state sidebar ke cookie
        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            ...
            <SheetDescription className="sr-only">
              Menu navigasi utama dan pengaturan.
            </SheetDescription>
