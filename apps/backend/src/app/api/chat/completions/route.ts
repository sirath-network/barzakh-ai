    ...
    if (groupId === "imagine") {
      ...
      if (hasNewUpload) {
        ...
        console.log("Image URL sources:", imageUrls.map(url => {
          if (url.includes('r2.sirath.network') || url.includes('.r2.cloudflarestorage.com')) return 'Cloudflare R2 Storage';
        ...
        if (imageUrls.length > 0) {
          ...
          const r2Urls = imageUrls.filter(url => url.includes('r2.sirath.network') || url.includes('.r2.cloudflarestorage.com'));
