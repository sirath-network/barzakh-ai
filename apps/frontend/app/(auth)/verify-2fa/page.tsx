...
function Verify2FAContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gradient-to-br dark:from-black dark:via-zinc-950 dark:to-zinc-900 flex items-center justify-center p-4">
        ...
        <div className="bg-white dark:bg-black/80 rounded-2xl shadow-2xl border border-gray-200 dark:border-zinc-800/50 overflow-hidden backdrop-blur-sm">
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              <div className="w-16 h-16 bg-gray-100 dark:bg-zinc-800/50 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg border border-gray-200 dark:border-zinc-700/50">
                <Shield className="w-8 h-8 text-gray-600 dark:text-zinc-300" />
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-zinc-600 hover:bg-zinc-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-medium py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2"
              >
                {isLoading ? (
