    ...
    <div className="bg-white dark:bg-zinc-900/80 rounded-2xl shadow-2xl border border-gray-200 dark:border-zinc-800/50 overflow-hidden backdrop-blur-sm relative">
      ...
      <div className="relative">
        {isSubscribed && !isLoading ? (
          address ? (
            <div className="p-8 border-t border-gray-200 dark:border-zinc-800/30 text-sm space-y-4">
            ...
            <div className="p-8 border-t border-gray-200 dark:border-zinc-800/30 text-sm text-center">
          ...
          <>
            <div className="p-8 border-t border-gray-200 dark:border-zinc-800/30 text-sm space-y-4 blur-sm select-none pointer-events-none">
              <div className="flex justify-between items-center">
                <span className="text-gray-600 dark:text-gray-300">Address</span>
                <span className="font-medium text-gray-900 dark:text-white">
                  ---
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-gray-200/50 dark:bg-black/60 backdrop-blur-[1px]">
              <div className="text-center space-y-4 p-6">
                <div className="relative mx-auto w-16 h-16 flex items-center justify-center">
                  <div className="absolute inset-0 bg-gradient-to-r from-gray-500 to-gray-600 dark:from-zinc-600 dark:to-zinc-700 rounded-full animate-pulse opacity-20"></div>
                  ...
                  <Lock className="w-8 h-8 text-gray-600 dark:text-zinc-400 relative z-10" />
                </div>
