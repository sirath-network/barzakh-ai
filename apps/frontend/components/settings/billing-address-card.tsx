...
export function BillingAddressCard({ address, isLoading }: BillingAddressCardProps) {
                ...
                address ? (
                    <div className="p-8 border-t border-gray-200 dark:border-red-900/30 text-sm space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-gray-900 dark:text-white">{address.line1}</span>
                      </div>
                      {address.line2 && (
                        <div className="flex justify-between items-center">
                            <span className="text-gray-600 dark:text-gray-300">Address 2</span>
                            <span className="font-medium text-gray-900 dark:text-white">{address.line2}</span>
                        </div>
                      )}
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 dark:text-gray-300">City</span>
                        <span className="font-medium text-gray-900 dark:text-white">{address.city}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 dark:text-gray-300">State</span>
                        <span className="font-medium text-gray-900 dark:text-white">{address.state}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 dark:text-gray-300">ZIP Code</span>
                        <span className="font-medium text-gray-900 dark:text-white">{address.postal_code}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 dark:text-gray-300">Country</span>
                        <span className="font-medium text-gray-900 dark:text-white">{address.country}</span>
                      </div>
                    </div>
                ) : (
                    <div className="p-8 border-t border-gray-200 dark:border-red-900/30 text-sm text-center">
                        <p className="text-gray-500 dark:text-gray-400">No billing address on file. Please add one in the Stripe portal.</p>
                    </div>
                )
            ) : (
              <>
                  ...
                  <div className="text-center space-y-4 p-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300 max-w-sm">
                        Upgrade to a Barzakh Pro to manage your billing address.
                      </p>
                    </div>
                  </div>
                </div>
