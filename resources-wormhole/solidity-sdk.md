...
- Word Count: 721; Token Estimate: 1127
...
2. **Guardian Network**: [Guardians](/docs/protocol/infrastructure/guardians/){target=\_blank} validate these messages and sign them to produce [Verifiable Action Approvals (VAAs)](/docs/protocol/infrastructure/vaas/){target=\_blank}. For delegated chains, a delegated subset performs direct observation while Canonical Guardians wait for delegate quorum before signing. The final VAA remains a standard 13-of-19 multisignature attestation.
3. **Relayers**: Off-chain relayers or applications fetch the VAA and relay it to the target chain. Relayers act as the transport layer of the Wormhole network, responsible for carrying signed messages between chains. In Wormhole’s protocol, this role is fulfilled by the [Executor](/docs/protocol/infrastructure/relayers/executor-framework/){target=\_blank}, a shared, permissionless framework for message delivery. The Executor enables anyone to act as a delivery provider through an open request-and-quote model, removing the need for centralized relayer services.
...
- Word Count: 1040; Token Estimate: 1399
...
- Summary: Learn how to create cross-chain contracts using Wormhole's Solidity SDK. Deploy contracts on Avalanche Fuji and Base Sepolia and send messages across chains.
- Word Count: 4045; Token Estimate: 7197
...
- Word Count: 2027; Token Estimate: 3009
...
- Word Count: 654; Token Estimate: 844
...
- Word Count: 1598; Token Estimate: 2170
...
2. Once a sufficient delegate quorum is reached or once Guardians independently observe the event, signatures accumulate until the required 13-of-19 quorum is achieved.
...
- Word Count: 885; Token Estimate: 1389
...
Page Title: Local Dev Environment

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-dev-env.md
- Canonical (HTML): https://wormhole.com/docs/tools/dev-env/
- Summary: Learn how to configure a development environment to build with Wormhole, including using the CLI, local validators, testing on public test networks, and more.
- Word Count: 659; Token Estimate: 994
...
- Word Count: 615; Token Estimate: 1238
...
- Word Count: 1268; Token Estimate: 1909
...
- Word Count: 1769; Token Estimate: 2648
...
Page Title: Toolkit FAQs

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-faqs.md
- Canonical (HTML): https://wormhole.com/docs/tools/faqs/
- Summary: FAQs on Wormhole Toolkit, covering Wormholescan, CLI, SDKs (TypeScript, Solidity), Tilt, error handling, transaction history, and manual VAA submission.
- Word Count: 429; Token Estimate: 664
...
- Word Count: 2154; Token Estimate: 3321
...
Page Title: Wormhole CLI

- Resolved Markdown: https://wormhole.com/docs/ai/pages/tools-cli-get-started.md
- Canonical (HTML): https://wormhole.com/docs/tools/cli/get-started/
- Summary: Learn how to install and use the Wormhole CLI, including commands and examples for managing multichain deployments, generating VAAs, and querying contract info.
- Word Count: 1567; Token Estimate: 3405
