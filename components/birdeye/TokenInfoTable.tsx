...
const TokenInfoTable: React.FC<{
  ...
  return (
    <div>
      {/* <div className=" p-2">
        <h2 className="text-lg">Token Found</h2>
      </div> */}
      <div className="bg-black text-white px-4 rounded-lg w-full max-w-4xl overflow-x-auto">
        {result.map((token, index) => (
          <div
            key={index}
            className="border border-gray-700 p-4 my-3 rounded-lg"
          >
            {/* Token Header */}
            ...
            {token.attributes.implementations.length > 0 && (
              <div className="mt-4">
                <h3 className="text-lg font-semibold border-b border-gray-700 p-2">
                  Blockchain Implementations
                </h3>
            ...
            {token.attributes.external_links.length > 0 && (
              <div className="mt-4">
                ...
                <div className="text-sm text-blue-400 flex flex-row flex-wrap justify">
